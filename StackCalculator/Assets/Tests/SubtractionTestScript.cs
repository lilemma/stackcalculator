...
public class SubtractionTestScript
{
    [Test]
    public void SubtractionTestScriptOperationPasses()
    {
        var calculator = new StackCalculator();

        EvaluateExpression(calculator, "5 5-", 1, 0);
        EvaluateExpression(calculator, "5 5-10-", 1, 10);
        EvaluateExpression(calculator, "55 10-", 1, -45);
        EvaluateExpression(calculator, "1 1 - 1 1 --", 1, 0);
    }
